...
if __name__ == "__main__":
    ...
    for i in zoo:
        f.write(i + '\n') # каждый элемент будет добавлен как отдельная строка
    # добавьте все элементы в файл
    f.writelines(zoo) # Элементы добавлены одной строкой
    f.writelines(map(lambda word: word + '\n', zoo)) # Добавлен массив элементов, каждый из которых расположн на отдельногй строке
    f.close()
