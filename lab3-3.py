...
python = str(monty_python.split()[1])		# Используйте оператор среза для получения подстроки “Python”
...
print('ice' in ice_cream and 'Ice' in ice_cream and 'ice ' in ice_cream)
...
first = phrase[:int(len(phrase)) // 2 + 1]
print(first)